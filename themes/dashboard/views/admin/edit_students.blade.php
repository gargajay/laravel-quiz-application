          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('admin/edit_students_final')}}" class="database_operation1" method="post">  
                        <div class="row">
                          <input type="hidden" name="id" value="{{ $students->id}}">
                            ...
                            <div class="col-sm-12">
                              <div class="form-group">
                                  ...
                                  {{ csrf_field()}}
                                  <textarea name="comment" id="" cols="30" rows="10" class="form-control">{{$students->comment}}</textarea>
                              </div>
                          </div>
                            {{-- <div class="col-sm-12">
                                <div class="form-group">
